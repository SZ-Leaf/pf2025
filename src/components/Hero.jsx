...
const Hero = () => {
  return (
    <section className='relative w-full h-screen mx-auto'>
      ...
      <div className='absolute bottom-0 bottom-32 w-full flex justify-center items-center'>
        <a href="$about">
          <div className='w-[25px] h-[50px] rounded-3xl border-2 border-secondary items-start flex justify-center p-2'>
            <motion.dev 
              animate={{
                y: [0, 20 , 0]
              }}
